...
docker build --rm -t leoontheearth/php:8.5 -f Dockerfile-PHP85 .
...
docker build --rm -t leoontheearth/php:8.5-fpm -f Dockerfile-PHP85-FPM .
...
docker image push leoontheearth/php:8.5
...
docker image push leoontheearth/php:8.5-fpm
...
```shell
# Run image
docker run -t -i --rm leoontheearth/php:8.5 sh
...
docker run -t -i --rm leoontheearth/php:8.5-fpm sh
